...
= 1.2.0 =
* Migrated from create-guten-block to @wordpress/create-block
* Added option for title attribute
* Removed stylesheet loading
* Removed !important option (no longer supported by React)
* Adding some help messages
